...
# FIXME: RUN if [ "\$CONZEPT_PREVENT_COVER_FETCH" = "false" ] ; then . settings.conf && cd $CONZEPT_WEB_DIR$CONZEPT_BASE_DIR/app/explore2/tools/ && sh ./get_previous_month_covers.sh ; fi
