...
Conzept is an attempt to create an **encyclopedic system for the 21st century**. A modern topic-exploration tool based on: Wikipedia, Wikidata, Open Library, Archive.org, YouTube, Global Biodiversity Information Facility and many other information sources. A semantic web app build for fun, education and research.
