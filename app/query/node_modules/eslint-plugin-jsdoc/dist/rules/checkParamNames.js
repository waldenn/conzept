...
const validateParameterNames = (targetTagName, allowExtraTrailingParamDocs, checkRestProperty, checkTypesRegex, enableFixer, functionParameterNames, jsdoc, jsdocNode, utils, report) => {
...
var _default = (0, _iterateJsdoc.default)(({
  ...
  const isError = validateParameterNames(targetTagName, allowExtraTrailingParamDocs, checkRestProperty, checkTypesRegex, enableFixer, functionParameterNames, jsdoc, jsdocNode, utils, report);
