...
const getUtils = (node, jsdoc, jsdocNode, settings, report, context, iteratingAll, ruleConfig) => {
  ...
  utils.avoidDocs = () => {
    var _context$options$0$ex, _context$options$2;
    ...
    const exemptedBy = (_context$options$0$ex = (_context$options$2 = context.options[0]) === null || _context$options$2 === void 0 ? void 0 : _context$options$2.exemptedBy) !== null && _context$options$0$ex !== void 0 ? _context$options$0$ex : ['inheritDoc', ...(settings.mode === 'closure' ? [] : ['inheritdoc'])];
  ...
  utils.hasOptionTag = tagName => {
    var _context$options$3;

    const {
      tags
    } = (_context$options$3 = context.options[0]) !== null && _context$options$3 !== void 0 ? _context$options$3 : {};
...
const getSettings = context => {
  ...
  const settings = {
    ...
    overrideReplacesDocs: (_context$settings$jsd10 = context.settings.jsdoc) === null || _context$settings$jsd10 === void 0 ? void 0 : _context$settings$jsd10.overrideReplacesDocs,
