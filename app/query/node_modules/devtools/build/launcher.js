...
async function launchChrome(capabilities) {
    ...
    const chromeFlags = [
        ...
        ...[
            ...
            `--window-size=${(deviceMetrics === null || deviceMetrics === void 0 ? void 0 : deviceMetrics.width) || constants_1.DEFAULT_WIDTH},${(deviceMetrics === null || deviceMetrics === void 0 ? void 0 : deviceMetrics.height) || constants_1.DEFAULT_HEIGHT}`
        ],
        ...(headless ? [
            '--headless',
            '--no-sandbox'
