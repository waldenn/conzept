...
var MolView = {
	...
	init: function()
	{
		...
		{
			//ga("send", "exception", { "exDescription": url + " " + row + "," + column + ": " + message, "exFatal": false, });
		};

		$(document).ajaxError(function(e, request, settings)
		{
			//ga("send", "exception", { "exDescription": "AJAX error: " + settings.type + " " + settings.url + ": " + request.statusText, "exFatal": false });
		});
