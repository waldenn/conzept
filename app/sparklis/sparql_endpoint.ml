...
(* let config_proxy_url = new Config.string_input ~key:"proxy_url" ~input_selector:"#input-proxy-url" ~default:"https://conze.pt/app/cors/raw/?url=" () *)

let config_method_get = true
(* let config_method_get = new Config.boolean_input ~key:"method_get" ~input_selector:"#input-method-get" ~default:true () *)
