...
$main_script = '
  ...
  <script src="../app/explore2/dist/datasources/harvard/index.js?vCONZEPT_VERSION"></script>
  <script src="../app/explore2/dist/datasources/loc/index.js?vCONZEPT_VERSION"></script>
  <script src="../app/explore2/dist/datasources/dpla/index.js?vCONZEPT_VERSION"></script>
  ...
  <script src="../app/explore2/dist/datasources/wikiquote/index.js?vCONZEPT_VERSION"></script>
  ...
  <!-- legal -->
  <script src="../app/explore2/dist/datasources/courtlistener/index.js?vCONZEPT_VERSION"></script>

  <!-- code -->
  <script src="../app/explore2/dist/datasources/searchcode/index.js?vCONZEPT_VERSION"></script>

  <!-- media -->
  <script src="../app/explore2/dist/datasources/peertube/index.js?vCONZEPT_VERSION"></script>
  <script src="../app/explore2/dist/datasources/sketchfab/index.js?vCONZEPT_VERSION"></script>
  <!--script src="../app/explore2/dist/datasources/freesound/index.js?vCONZEPT_VERSION"></script-->
          ...
          <div class="overflow-container" tabindex="-1">
            ...
            <div class="overflow-content">
              ...
              <details id="detail-geospatial-search" class="special-detail" title="geospatial search" style="display:none;">
                ...
                <summary>
                  <i title="geospatial search" class="fa-solid fa-search fa-flip-horizontal" title="geospatial search"></i> <span id="app-menu-nearby-search-title"></span>
                ...
                <div id="bookmarks-actions-media" class="noselect">
                  <details class="frontpage" style="" closed=""><summary><span id="app-menu-bookmark-actions-media">media</span></summary>
                    <div class="frontpage-grid-container">
                      ...
                      <div class="bookmark-action"><a class="" title="Conzept reference datasources search" aria-label="Conzept reference datasources search" role="button" href="javascript:void(0)" onclick="runBookmarkAction(&quot;conzept-search-reference&quot;)"><span class="icon"><i class="fa-brands fa-searchengin fa-2x"></i></span><br><span class="frontpage-icon"><span id="app-guide-bookmark-web-search">reference search</span></span></a></div>

                      <div class="bookmark-action"><a class="" title="Conzept culture datasources search" aria-label="Conzept culture datasources search" role="button" href="javascript:void(0)" onclick="runBookmarkAction(&quot;conzept-search-culture&quot;)"><span class="icon"><i class="fa-brands fa-searchengin fa-2x"></i></span><br><span class="frontpage-icon"><span id="app-guide-bookmark-web-search">culture search</span></span></a></div>

                      <div class="bookmark-action"><a class="" title="Conzept science datasources search" aria-label="Conzept science datasources search" role="button" href="javascript:void(0)" onclick="runBookmarkAction(&quot;conzept-search-science&quot;)"><span class="icon"><i class="fa-brands fa-searchengin fa-2x"></i></span><br><span class="frontpage-icon"><span id="app-guide-bookmark-web-search">science search</span></span></a></div>

                      <div class="bookmark-action"><a class="" title="Conzept business datasources search" aria-label="Conzept business datasources search" role="button" href="javascript:void(0)" onclick="runBookmarkAction(&quot;conzept-search-business&quot;)"><span class="icon"><i class="fa-brands fa-searchengin fa-2x"></i></span><br><span class="frontpage-icon"><span id="app-guide-bookmark-web-search">business search</span></span></a></div>

                      <div class="bookmark-action"><a class="" title="Conzept legal datasources search" aria-label="Conzept legal datasources search" role="button" href="javascript:void(0)" onclick="runBookmarkAction(&quot;conzept-search-legal&quot;)"><span class="icon"><i class="fa-brands fa-searchengin fa-2x"></i></span><br><span class="frontpage-icon"><span id="app-guide-bookmark-web-search">legal search</span></span></a></div>

                      <div class="bookmark-action"><a class="" title="Conzept news datasources search" aria-label="Conzept news datasources search" role="button" href="javascript:void(0)" onclick="runBookmarkAction(&quot;conzept-search-news&quot;)"><span class="icon"><i class="fa-brands fa-searchengin fa-2x"></i></span><br><span class="frontpage-icon"><span id="app-guide-bookmark-web-search">news search</span></span></a></div>

                      <div class="bookmark-action"><a class="" title="Conzept media datasources search" aria-label="Conzept media datasources search" role="button" href="javascript:void(0)" onclick="runBookmarkAction(&quot;conzept-search-media&quot;)"><span class="icon"><i class="fa-brands fa-searchengin fa-2x"></i></span><br><span class="frontpage-icon"><span id="app-guide-bookmark-web-search">media search</span></span></a></div>

                      <div class="bookmark-action"><a class="" title="Conzept web datasources search" aria-label="Conzept web datasources search" role="button" href="javascript:void(0)" onclick="runBookmarkAction(&quot;conzept-search-web&quot;)"><span class="icon"><i class="fa-brands fa-searchengin fa-2x"></i></span><br><span class="frontpage-icon"><span id="app-guide-bookmark-web-search">web search</span></span></a></div>

                      <div class="bookmark-action"><a class="" title="search Bing" aria-label="search Bing" role="button" href="javascript:void(0)" onclick="runBookmarkAction(&quot;command-web&quot;)"><span class="icon"><i class="fa-brands fa-searchengin fa-2x"></i></span><br><span class="frontpage-icon"><span id="app-guide-bookmark-web-search">Bing search</span></span></a></div>
...
if ( strstr($ua_string, " AppleWebKit/") && strstr($ua_string, " Safari/") && !strstr($ua_string, " CriOS") ){
    ...
    echo '<link rel="stylesheet" href="../app/explore2/dist/css/conzept/safari.css?vCONZEPT_VERSION">';
