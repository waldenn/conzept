...
(function($){
	...
	$.fn.fontselect = function(options) {
		...
		var settings = {
			...
			localFontsUrl: '/fonts/',
			systemFonts: 'Quicksand|Athiti|Barlow|Encode+Sans|Gothic+A1|Hind|IBM+Plex+Sans|IBM+Plex+Sans+Condensed|Karma|KoHo|Krub|Libre+Franklin|Livvic|Mada|Mukta|Raleway|Roboto|Rubik|Saira+Semi+Condensed|Work+Sans'.split('|'),
			//systemFonts: 'Athiti|Arial|Dangrek|Overlock|Buda|Helvetica+Neue|Hepta+Slab|Heebo|Prosto+One|PT+Sans|Montserrat|Mandali|Lato|Source+Sans+Pro|Open+Sans|Crimson+Text|Khula|Courier+New|Times+New+Roman|Verdana|Impact'.split('|'),
