...
(function ($) {
	...
	var lcl = function(obj, settings) {
      ...
      if ( typeof size === undefined || typeof size === 'undefined' ){
        //console.log('warning: no size indicated for cast to px');
        return 1;
      }
    ...
    // CONZEPT PATCH
      ...
      $('#openseadragon').show;
      $('#openseadragon').css('display','inline');
      // toggle openseadragon element display
      window.viewer.setFullScreen(true);
