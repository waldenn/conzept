      ...
      <div id="search-options" style="">&nbsp;
        ...
        <span class="geofilter">
          ...
          <div id="geofilter-popover" class="resizer" popover="auto">
            ...
            <iframe id="geospatial-search-frame" class="resized" title="geospatial search" role="application" loading="lazy" style="min-height: 401px" src="https://localhost/app/geofilter/index.html?l=${explore.language}&lat=&lon=&radius=" allowvr="yes" allow="autoplay; fullscreen" allowfullscreen="" allow-downloads="" width="70vw height="70vh%" loading="lazy">geofilter iframe</iframe>
