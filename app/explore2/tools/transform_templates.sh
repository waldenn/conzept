...
find ../../ -maxdepth 1 -mindepth 1 -type d | while read dir; do
  ...
  then
    sed -e "s|CONZEPT_COMMON_HTML_INCLUDE_NO_JQUERY|$CONZEPT_COMMON_HTML_INCLUDE_NO_JQUERY|g ; s|CONZEPT_COMMON_HTML_INCLUDE|$CONZEPT_COMMON_HTML_INCLUDE|g ; s|CONZEPT_VERSION|$CONZEPT_VERSION|g ; s|CONZEPT_WEB_BASE|$CONZEPT_WEB_BASE|g ; s|CONZEPT_LOCALES|$CONZEPT_LOCALES|g ; s|CONZEPT_TRACKER_HTML_INCLUDE|$CONZEPT_TRACKER_HTML_INCLUDE|g" "$dir/index.template.html"  > "$dir/index.html"
  fi
  ...
  then
    sed -e "s|CONZEPT_COMMON_HTML_INCLUDE_NO_JQUERY|$CONZEPT_COMMON_HTML_INCLUDE_NO_JQUERY|g ; s|CONZEPT_COMMON_HTML_INCLUDE|$CONZEPT_COMMON_HTML_INCLUDE|g ; s|CONZEPT_VERSION|$CONZEPT_VERSION|g ; s|CONZEPT_WEB_BASE|$CONZEPT_WEB_BASE|g" "$dir/header_index.template.php"  > "$dir/header_index.php"
  fi
