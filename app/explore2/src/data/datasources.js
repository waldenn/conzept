const datasources = {
  ...
  */
  ...
  'sketchfab': {
    ...
    url:                    '${datasources.sketchfab.endpoint}?type=models&q=${term}&count=${datasources.sketchfab.pagesize}&cursor=${datasources.sketchfab.cursor}&sort_by=${ valid( sortby )? sortby : "" }',
    cursor:                 '',
