const datasources = {
  ...
  */
  ...
  'gbif': {
    ...
    url:                    '${datasources.gbif.endpoint}/search?verbose=true&rank=species&q=${term}&limit=${datasources.gbif.pagesize}&offset=${ (explore.page -1) * datasources.gbif.pagesize }&rank=SPECIES&isExtinct=false&hl=true',
