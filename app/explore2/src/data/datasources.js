const datasources = {
  ...
  'dpla': {
    ...
    url:                    '${datasources.dpla.endpoint}?q=${ term }&sourceResource.language=${ explore.language_name }&page_size=${ datasources.dpla.pagesize }&page=${ explore.page }&${ valid( filterby ) && Object.values( d.filter_map ).includes( filterby ) ? "sourceResource.format=" + filterby : "" }&sort_by=${ valid( sortby )? sortby : "" }&sortOrder=${ getSortDirection( source ) }&{ valid( [ datemin, datemax ] )? "&sourceResource.date.after=" + datemin + "&sourceResource.date.before=" + datemax : "" }&api_key=5da031c24e1d76c95e3d69f27ea5a875',
    ...
    autocomplete_active:    true,
    autocomplete_protocol:  'json',
    autocomplete_url:       '${datasources.dpla.endpoint}?q=${ term }&sourceResource.language=${ explore.language_name }&page_size=${ datasources.dpla.autocomplete_limit }&page=1&${ valid( filterby ) && Object.values( d.filter_map ).includes( filterby ) ? "sourceResource.format=" + filterby : "" }&sort_by=${ valid( sortby )? sortby : "" }&sortOrder=${ getSortDirection( source ) }&{ valid( [ datemin, datemax ] )? "&sourceResource.date.after=" + datemin + "&sourceResource.date.before=" + datemax : "" }&api_key=5da031c24e1d76c95e3d69f27ea5a875',
    autocomplete_format:    'json',
    autocomplete_connect:   'json',
    autocomplete_limit:     `${explore.datasource_autocomplete_limit}`,
  },
