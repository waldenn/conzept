const datasources = {
  ...
  */
  ...
  'occrp': {
    ...
    url:                    '${datasources.occrp.endpoint}?q=${term.replaceAll( "\"", "%22")}&page=${explore.page}&limit=${datasources.occrp.pagesize}&filter:schemata=Thing',
    ...
    autocomplete_active:    true,
    autocomplete_protocol:  'json',
    autocomplete_url:       '${datasources.occrp.endpoint}?q=${term.replaceAll( "\"", ""}&page=1&limit=${datasources.occrp.autocomplete_limit}&filter:schemata=Thing',
    autocomplete_format:    'json',
    autocomplete_connect:   'json',
    autocomplete_limit:     `${explore.datasource_autocomplete_limit}`,
  },
