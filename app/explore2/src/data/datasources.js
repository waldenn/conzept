const datasources = {
  ...
  'wikiquote': {
    ...
    name:                   'Wikiquote',
    set:                    'culture',
    description:            'quote compendium',
    tag:                    'quote',
    qid:                    'Q369',
    protocol:               'rest',
    endpoint:               'wikiquote.org/w/api.php',
    format:                 'json',
    connect:                'jsonp',
    headers:                '',
    pagesize:               `${explore.datasource_page_size}`,
    ...
    code_render_mark:       'renderMarkWikiquote( inputs, source, q_, show_raw_results, id )',
    autocomplete_active:    true,
    autocomplete_protocol:  'json',
    autocomplete_url:       'https://${explore.language}.${datasources.wikiquote.endpoint}?action=query&srlimit=${datasources.wikiquote.autocomplete_limit}&sroffset=0&srsort=${ valid( sortby )? sortby : "relevance" }&format=json&list=search&redirects=1&srsearch=${term}&srnamespace=0&srenablerewrites=1',
    autocomplete_format:    'json',
    autocomplete_connect:   'jsonp',
    autocomplete_limit:     `${explore.datasource_autocomplete_limit}`,
    autocomplete_mode:      'fuzzy',
  ...
  */
  ...
  'openalex': {
    ...
    url:                    '${datasources.openalex.endpoint}?filter=default.search:${term.replace(/,/g, "")},language:languages/${explore.language}|languages/en${ valid( geofilter_country ) ? ",authorships.countries%3Acountries%2F" + geofilter_country : "" }&sort=${ valid( sortby )? sortby : "relevance_score:desc" }&page=${explore.page}&per-page=${datasources.openalex.pagesize}',
    icon:                   '<img class="datasource-icon" alt="OpenAlex logo" src="/assets/icons/openalex.svg" alt="OpenAlex logo">',
    icon_invert:            true,
    color:                  '#cbdff7',
    display_url:            'https://openalex.org/works/${gid}',
  ...
  'arxiv': {
    ...
    url:                    '${datasources.arxiv.endpoint}?search_query=all:${term}&sortBy=${ valid( sortby )? sortby : "relevance" }&sortOrder=${ getSortDirection( source, "long" ) }&start=${ ( explore.page - 1) * datasources.arxiv.pagesize }&max_results=${datasources.arxiv.pagesize}',
    ...
    autocomplete_active:    true,
    autocomplete_protocol:  'json',
    autocomplete_url:       '${datasources.arxiv.endpoint}?search_query=all:${term}&sortBy=${ valid( sortby )? sortby : "relevance" }&sortOrder=${ getSortDirection( source, "long" ) }&start=0&max_results=${datasources.arxiv.autocomplete_limit}',
    autocomplete_format:    'json',
  ...
  */
  ...
  'wikispecies': {
    ...
    qid:                    'Q13679',
    protocol:               'rest',
    endpoint:               'wikispecies.org/w/api.php',
    format:                 'json',
    connect:                'jsonp',
    headers:                '',
    pagesize:               `${explore.datasource_page_size}`,
    ...
    code_autocomplete:      'autocompleteWikispecies( r, dataset )',
    code_resolve:           'resolveWikispecies( result, renderObject )',
    code_render_mark:       'renderMarkWikispecies( inputs, source, q_, show_raw_results, id )',
    autocomplete_active:    true,
    autocomplete_protocol:  'json',
    autocomplete_url:       'https://${explore.language}.${datasources.wikispecies.endpoint}?action=query&srlimit=${datasources.wikispecies.autocomplete_limit}&sroffset=0&srsort=${ valid( sortby )? sortby : "relevance" }&format=json&list=search&redirects=1&srsearch=${term}&srnamespace=0&srenablerewrites=1',
    autocomplete_format:    'json',
    autocomplete_connect:   'jsonp',
    autocomplete_limit:     `${explore.datasource_autocomplete_limit}`,
    autocomplete_mode:      'fuzzy',
  ...
  */
  ...
  'world_bank': {
    ...
    sort_map:               { // &sort=docdt&order=asc
                              ...
                              'update-asc'      : 'docdt',
                              'random'          : 'id',
                              'citations-desc'  : 'src_cit',
                              'citations-asc'   : 'src_cit',
                              'title-desc'      : 'display_title',
                              'title-asc'       : 'display_title',
                              'distance-desc'   : '',
                              'distance-asc'    : '',
                            },
    media:                  [ 'text' ],
    ...
    color:                  '#082b7a',
    display_url:            '',
    code_autocomplete:      'autocompleteWorldBank( r, dataset )',
    code_data_collect:      'my_promises.push( processResultsWorldBank( topicResults, struct, index ) );',
    code_resolve:           'resolveWorldBank( result, renderObject )',
  ...
  'occrp': {
    ...
    url:                    '${datasources.occrp.endpoint}?q=${term.replace(/"/g, "%22")}&page=${explore.page}&limit=${datasources.occrp.pagesize}&filter:schemata=Thing',
    ...
    autocomplete_active:    true,
    autocomplete_protocol:  'json',
    autocomplete_url:       '${datasources.occrp.endpoint}?q=${term.replace(/"/g, "")}&page=1&limit=${datasources.occrp.autocomplete_limit}&filter:schemata=Thing',
    autocomplete_format:    'json',
    autocomplete_connect:   'json',
    autocomplete_limit:     `${explore.datasource_autocomplete_limit}`,
  },
  ...
  'searchcode': {
    ...
    name:                   'SearchCode',
    set:                    'code',
    description:            'sourcecode search - BETA',
    tag:                    'work',
    qid:                    'Q0',
    protocol:               'rest',
    endpoint:               'https://searchcode.com/api/codesearch_I/', // see: https://searchcode.com/api/
    format:                 'json',
    connect:                'json',
    headers:                '',
    pagesize:               `${explore.datasource_page_size}`,
    ...
    color:                  '#0a602496',
    display_url:            '${url}',
    code_autocomplete:      'autocompleteSearchCode( r, dataset )',
    code_data_collect:      'my_promises.push( processResultsSearchCode( topicResults, struct, index ) );',
    code_resolve:           'resolveSearchCode( result, renderObject )',
    code_render_mark:       'renderMarkSearchCode( inputs, source, q_, show_raw_results, id )',
    autocomplete_active:    false,
    autocomplete_protocol:  'json',
    autocomplete_url:       '${datasources.searchcode.endpoint}?q=${ encodeURIComponent( term ) }&p=1&per_page=${datasources.searchcode.autocomplete_limit}',
    autocomplete_format:    'json',
    autocomplete_connect:   'json',
    autocomplete_limit:     `${explore.datasource_autocomplete_limit}`,
  },
  ...
  'gdelt': {
    ...
    autocomplete_active:    false,
    autocomplete_protocol:  'json',
    autocomplete_url:       '${datasources.gdelt.endpoint}?format=html&timespan=2D&query=${ encodeURIComponent( term.replace(",", " ") }&searchlang=${explore.language_name}&mode=artlist&maxrecords=${datasources.gdelt.autocomplete_limit}&format=json',
  ...
  'peertube': {
    ...
    name:                   'PeerTube',
    set:                    'media',
    description:            'federated video network - BETA',
    tag:                    'web',
    qid:                    'Q50938515',
    protocol:               'rest',
  ...
  'sketchfab': {
    ...
    name:                   'Sketchfab',
    set:                    'media',
    description:            '3D model - BETA',
    tag:                    '3D',
    qid:                    'Q7534755',
    protocol:               'rest',
    endpoint:               'https://api.sketchfab.com/v3/search', // see: https://docs.sketchfab.com/data-api/v3/index.html#!/models/get_v3_me_search_type_models
    format:                 'json',
    connect:                'json',
    headers:                '',
    pagesize:               `${explore.datasource_page_size}`,
    sort_map:               {
                              ...
                              'date-desc'       : '-publishedAt',
                              'date-asc'        : 'publishedAt',
                              'update-desc'     : '-publishedAt',
                              'update-asc'      : 'publishedAt',
                              'random'          : '',
                              'citations-desc'  : '-viewCount',
                              'citations-asc'   : 'viewCount',
                              'title-desc'      : '',
                              'title-asc'       : '',
                              'distance-desc'   : '',
                              'distance-asc'    : '',
    ...
    color:                  '#ee9d1e99',
    display_url:            '${url}',
    code_autocomplete:      'autocompleteSketchfab( r, dataset )',
    code_data_collect:      'my_promises.push( processResultsSketchfab( topicResults, struct, index ) );',
    code_resolve:           'resolveSketchfab( result, renderObject )',
    code_render_mark:       'renderMarkSketchfab( inputs, source, q_, show_raw_results, id )',
    autocomplete_active:    true,
    autocomplete_protocol:  'json',
    autocomplete_url:       '${datasources.sketchfab.endpoint}?type=models&q=${term}&count=${datasources.sketchfab.autocomplete_limit}&sort_by=${ valid( sortby )? sortby : "" }',
    autocomplete_format:    'json',
    autocomplete_connect:   'json',
    autocomplete_limit:     `${explore.datasource_autocomplete_limit}`,
  },
