const datasources = {
  ...
  */
  ...
  'openalex': {
    ...
    url:                    '${datasources.openalex.endpoint}?search=${term}&sort=${ valid( sortby )? sortby : "relevance_score:desc" }&filter=language:${explore.language},language:en${ valid( geofilter_country ) ? ",authorships.countries%3Acountries%2F" + geofilter_country : "" }&page=${explore.page}&per-page=${datasources.openalex.pagesize}',
    ...
    autocomplete_active:    true,
    autocomplete_protocol:  'json',
    autocomplete_url:       '${datasources.openalex.endpoint}?search=${term}&sort=${ valid( sortby )? sortby : "relevance_score:desc" }&filter=language:${explore.language},language:en${ valid( geofilter_country ) ? ",authorships.countries%3Acountries%2F" + geofilter_country : "" }&page=1&per-page=${datasources.openalex.autocomplete_limit}',
    autocomplete_format:    'json',
    autocomplete_connect:   'json',
    autocomplete_limit:     `${explore.datasource_autocomplete_limit}`,
  },
