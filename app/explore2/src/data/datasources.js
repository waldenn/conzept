const datasources = {
  ...
  'commons': {
    ...
    icon:                   '<img class="datasource-icon" src="/assets/icons/commons.svg" alt="Wikimedia Commons logo">',
  ...
  'archive': {
    ...
    icon:                   '<img class="datasource-icon" src="/assets/icons/archive.svg" alt="Internet Archive logo">',
  ...
  'archive_scholar': {
    ...
    icon:                   '<img class="datasource-icon" src="/assets/icons/archive_scholar.svg" alt="Internet Archive Scholar logo">',
    display_url:            '${url}',
  ...
  'europeana': {
    ...
    icon:                   '<img class="datasource-icon" src="/assets/icons/europeana.svg" alt="Europeana logo">',
  ...
  'rijksmuseum': {
    ...
    icon:                   '<img class="datasource-icon" src="/assets/icons/rijksmuseum.svg" alt="Rijksmuseum logo">',
  ...
  'eu': {
    ...
    icon:                   '<img class="datasource-icon" src="/assets/icons/eu.svg" alt="EU flag">',
  ...
  'gbif': {
    active:                 false,
    name:                   'GBIF',
    description:            'species of life - BETA',
    tag:                    'science',
    qid:                    'Q1531570',
    protocol:               'rest',
    ...
    icon:                   '<img class="datasource-icon" src="/assets/icons/gbif.png" alt="GBIF logo">',
  ...
  'smithsonian3D': {
    ...
    icon:                   '<img class="datasource-icon" src="/assets/icons/smithsonian3D.svg" alt="Smithsonian logo">',
  ...
  'rkd': {
    ...
    //endpoint:               'https://conze.pt/app/proxy/rkd/',
    format:                 'json',
    connect:                'jsonp',
    pagesize:               5,
    url:                    '${datasources.rkd.endpoint}?query=${term}&format=json&callback=foo&rows=${datasources.rkd.pagesize}&start=${ ( (explore.page -1) * datasources.rkd.pagesize ) ',
    icon:                   '<img class="datasource-icon" src="/assets/icons/rkd.svg" alt="RKD logo">',
    display_url:            '',
    ...
    autocomplete_active:    true,
    autocomplete_protocol:  'json',
    autocomplete_url:       '${datasources.rkd.endpoint}?query=${term}&format=json&callback=foo&rows=${datasources.rkd.autocomplete_limit}&start=0',
    autocomplete_format:    'json',
    autocomplete_connect:   'jsonp',
    autocomplete_limit:     5,
  },
  ...
  'snomed': {
    ...
    icon:                   '<img class="datasource-icon" src="/assets/icons/snomed.png" alt="SNOMED CT logo">',
