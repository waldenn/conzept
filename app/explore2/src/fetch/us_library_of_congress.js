	...
	$.ajax({
          ...
          if ( v.contributor ){
              ...
              subtitle2 += '<div class="mv-extra-desc">' +
                  ...
                  '<a href="javascript:void(0)" class="mv-extra-icon" title="author" aria-label="author" role="button"' + setOnClick( Object.assign({}, args, { type: 'link', title: author_name, url: author_url, qid: '', language : explore.language } ) ) + '">' + name + '</a>' +
                '</div>';
