function fetchWikiQuote( args, url ){
	...
	$.ajax({
        ...
        json			= sortObjectsArray( json, 'title' );
          ...
          if ( typeof v.title === undefined || typeof v.title === 'undefined' ){
            ...
            label = v.title;
            url   = 'https://' + explore.language + '.wikiquote.org/wiki/' + v.title;
        ...
        let meta = {
          ...
          source        : 'WikiQuote',
          link          : 'https://' + explore.language + '.wikiquote.org/w/index.php?sort=last_edit_desc&search=' + keyword + '&title=Special%3ASearch&profile=advanced&fulltext=1&advancedSearch-current=%7B%7D&ns0=1&ns14=1',
