...
function insertRelatedPresentationTopics( qid ){
  ...
  const props_on_item = [
    ...
    'P144',   // based-on             https://www.wikidata.org/wiki/Property:P144
