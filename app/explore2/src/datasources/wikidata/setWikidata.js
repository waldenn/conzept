...
function addItemCountries( item, list, former ){
  ...
  if ( former ){ // check for former-countries instead
    ...
    list.forEach(( country_qid ) => { // for each country-qid
...
async function setWikidataPromise( item, wd, single, target_pane, callback ){
  ...
  return new Promise( (resolve, reject) => {
    ...
    if ( !valid( item.datasource ) ){
      item.datasource = '';
    }

    if ( !valid( item.country_qid ) ){
      item.country_qid    = '';
    }

    item.country_name   = ''; // needed to assume its use in fields
    ...
    if ( typeof item.title === undefined || isQid( item.title ) ){
      ...
      if ( valid( wd.labels ) ){ // we have some labels
        ...
        else if ( valid( wd.labels['fr'] ) ){ item.title = wd.labels['fr']; }
        else if ( valid( wd.labels['se'] ) ){ item.title = wd.labels['se']; }
        else if ( valid( wd.labels['es'] ) ){ item.title = wd.labels['es']; }
        else if ( valid( wd.labels['nl'] ) ){ item.title = wd.labels['nl']; }
        else if ( valid( wd.labels['it'] ) ){ item.title = wd.labels['it']; }
        else if ( valid( wd.labels['pt'] ) ){ item.title = wd.labels['pt']; }
        else if ( valid( wd.labels['ja'] ) ){ item.title = wd.labels['ja']; }
        else if ( valid( wd.labels['ceb']) ){ item.title = wd.labels['ceb']; }
        else if ( valid( wd.labels['arz']) ){ item.title = wd.labels['arz']; }
        else if ( valid( wd.labels['war']) ){ item.title = wd.labels['war']; }
        else if ( valid( wd.labels['ar'] ) ){ item.title = wd.labels['ar']; }
        else if ( valid( wd.labels['ru'] ) ){ item.title = wd.labels['ru']; }
        else if ( valid( wd.labels['pl'] ) ){ item.title = wd.labels['pl']; }
        else if ( valid( wd.labels['zh'] ) ){ item.title = wd.labels['zh']; }
        else if ( valid( wd.labels['vi'] ) ){ item.title = wd.labels['vi']; }
        else if ( valid( wd.labels['uk'] ) ){ item.title = wd.labels['uk']; }
        else if ( valid( wd.labels['fa'] ) ){ item.title = wd.labels['fa']; }
        else if ( valid( wd.labels['id'] ) ){ item.title = wd.labels['id']; }
        else if ( valid( wd.labels['ca'] ) ){ item.title = wd.labels['ca']; }
        else if ( valid( wd.labels['sr'] ) ){ item.title = wd.labels['sr']; }
        else if ( valid( wd.labels['tr'] ) ){ item.title = wd.labels['tr']; }
        else if ( valid( wd.labels['id'] ) ){ item.title = wd.labels['id']; }
        else if ( valid( wd.labels['cs'] ) ){ item.title = wd.labels['cs']; }
