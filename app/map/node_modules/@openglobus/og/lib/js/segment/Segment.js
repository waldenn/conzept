...
export function getTileCellIndex(coordinate, tileSize, worldEdge) {
    return Math.floor(Math.abs(worldEdge - coordinate) / tileSize);
}
export function getTileCellExtent(x, y, z, worldExtent) {
    let pz = 1.0 / (1 << z);
...
export function getTileGroupByLat(lat, maxLat = MAX_LAT) {
    if (lat > maxLat) {
