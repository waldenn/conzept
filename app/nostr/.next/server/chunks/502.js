...
const basePath = "/app/nostr-search/out" || 0;
...
const _normalizetrailingslash = __webpack_require__(1738);
const basePath = (/* unused pure expression or super */ null && ("/app/nostr-search/out" || 0));
...
module.exports = createProxy("/home/jama/dev/conzept/app/nostr-search/node_modules/next/dist/client/components/app-router.js");
 //# sourceMappingURL=app-router.js.map
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy } = __webpack_require__(7814);
module.exports = createProxy("/home/jama/dev/conzept/app/nostr-search/node_modules/next/dist/client/components/error-boundary.js");
 //# sourceMappingURL=error-boundary.js.map
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy } = __webpack_require__(7814);
module.exports = createProxy("/home/jama/dev/conzept/app/nostr-search/node_modules/next/dist/client/components/layout-router.js");
 //# sourceMappingURL=layout-router.js.map
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy } = __webpack_require__(7814);
module.exports = createProxy("/home/jama/dev/conzept/app/nostr-search/node_modules/next/dist/client/components/render-from-template-context.js");
 //# sourceMappingURL=render-from-template-context.js.map
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy } = __webpack_require__(7814);
module.exports = createProxy("/home/jama/dev/conzept/app/nostr-search/node_modules/next/dist/client/components/static-generation-searchparams-bailout-provider.js");
 //# sourceMappingURL=static-generation-searchparams-bailout-provider.js.map
...
/* harmony export */   xW: () => (/* binding */ schnorr)
/* harmony export */ });
/* unused harmony exports CURVE, Point, Signature, getPublicKey, recoverPublicKey, getSharedSecret, sign, signSync, verify */
...
__webpack_require__.d(__webpack_exports__, {
  $Q: () => (/* binding */ decodeBech32ID),
  Ps: () => (/* binding */ encodeBech32ID),
  NL: () => (/* binding */ normalizeWsURL)
});
...
// EXTERNAL MODULE: ./node_modules/@noble/secp256k1/lib/esm/index.js
var esm = __webpack_require__(628);
;// CONCATENATED MODULE: ./node_modules/nostr-mux/dist/core/utils.js
...
const encodeBech32ID = (prefix, hexID) => {
    try {
        return bech32.encode(prefix, bech32.toWords(esm/* utils */.P6.hexToBytes(hexID)));
    }
    catch (_a) {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  wU: () => (/* reexport */ AutoProfileSubscriber),
  vh: () => (/* reexport */ Mux),
  ZD: () => (/* reexport */ relay_Relay),
  up: () => (/* reexport */ parseGenericProfile)
});

// UNUSED EXPORTS: LogLevel, Personalizer, Plugin, generateID, utils, validateEvent, verifyEvent

// EXTERNAL MODULE: ./node_modules/@noble/secp256k1/lib/esm/index.js
var esm = __webpack_require__(628);
;// CONCATENATED MODULE: ./node_modules/nostr-mux/dist/core/event.js
...
const validateTags = (taintedTags) => {
 ...
 */
const generateID = (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return esm/* utils */.P6.bytesToHex(yield esm/* utils */.P6.sha256(new Uint8Array(encoded)));
});
/**
 ...
 * @returns If `tainted` is valid event, Then `Event`. Else `string` represents reason for invalidation.
 */
const verifyEvent = (mayBeEvent) => __awaiter(void 0, void 0, void 0, function* () {
    const event = validateEvent(mayBeEvent);
    if (typeof event === 'string') {
        return `failed to verify event: ${event}`;
    }
    if (event.id !== (yield generateID(event))) {
        return 'failed to verify event: id property is invalid';
    }
    if (!(yield esm/* schnorr */.xW.verify(event.sig, event.id, event.pubkey))) {
        return 'failed to verify event: sig property is invalid';
    }
    return event;
});

;// CONCATENATED MODULE: ./node_modules/nostr-mux/dist/core/logger.js
const LogLevel = {
    debug: 10,
    info: 20,
    warn: 30,
...
const logger_buildSimpleLogger = (logger) => {
...
;// CONCATENATED MODULE: ./node_modules/nostr-mux/dist/core/emitter.js
class emitter_SimpleEmitter {
    constructor() {
        this.listeners = [];
    }
    listen(listener) {
...
// EXTERNAL MODULE: ./node_modules/nostr-mux/dist/core/utils.js + 1 modules
var utils = __webpack_require__(2683);
;// CONCATENATED MODULE: ./node_modules/nostr-mux/dist/core/relay.js
var relay_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
 ...
 */
const validateRelayMessage = (wsMessage) => relay_awaiter(void 0, void 0, void 0, function* () {
    let msg;
    try {
    ...
    switch (msg[0]) {
        case 'EVENT':
            ...
            const event = yield verifyEvent(msg[2]);
            if (typeof event === 'string') {
...
const buildErrorCommandResult = (eventID, message) => ({ type: 'OK', eventID, accepted: false, message: `error: client ${message}` });
/**
 * `Relay` implements low-level operation to communicate relay.
 */
class relay_Relay {
    constructor(url, options = {}) {
        const normalized = (0,utils/* normalizeWsURL */.NL)(url);
        if (!normalized) {
        ...
        this.log = logger_buildSimpleLogger(options.logger);
        ...
        this.subs = {};
        this.cmds = {};
        this.onHealthy = new emitter_SimpleEmitter();
        this.onEvent = new emitter_SimpleEmitter();
        this.onEose = new emitter_SimpleEmitter();
        this.onResult = new emitter_SimpleEmitter();
        this.handleWSOpen = () => {
        ...
        this.handleWSMessage = (e) => relay_awaiter(this, void 0, void 0, function* () {
            this.keepAlived();
            const msg = yield validateRelayMessage(e);
    ...
    publish(event, timeout = 5000) {
        ...
        if (this.isHealthy) {
            (_a = this.ws) === null || _a === void 0 ? void 0 : _a.send(JSON.stringify(['EVENT', event]));
        }
    ...
    request(subID, filters, options = {}) {
        ...
        (_a = this.ws) === null || _a === void 0 ? void 0 : _a.send(JSON.stringify(['REQ', subID, ...filters]));
...
;// CONCATENATED MODULE: ./node_modules/nostr-mux/dist/core/mux.js

class mux_Plugin {
    install(mux) { }
    uninstall() { }
    capturePublishedEvent(event) { }
    captureRequestedFilter(filter) { }
    captureReceivedEvent(e) { }
}
class EventMatcher {
    constructor(filter) {
        if (filter.ids) {
...
const atLeastOneEvent = (events) => {
    return events.length > 0;
};
class Subscription {
    constructor(id, initialRelays, subOptions) {
        this.id = id;
        ...
        if (this.eoseWaitList.size === 0) {
            setTimeout(() => { var _a; return (_a = this.eoseHandler) === null || _a === void 0 ? void 0 : _a.call(this, this.id); }, 0);
        }
    }
    get isAfterEose() {
    ...
    consumeEose(senderRelayURL) {
        var _a, _b;
        if (!this.eoseWaitList.has(senderRelayURL)) {
            return;
        }
        this.eoseWaitList.delete(senderRelayURL);
        (_a = this.partialEoseHandler) === null || _a === void 0 ? void 0 : _a.call(this, this.id, senderRelayURL, this.expectedEosesCount, this.eoseWaitList.size);
        if (this.isAfterEose) {
            this.flushBuffered(); // We SHOULD maintain EVENT and EOSE ordering.
            (_b = this.eoseHandler) === null || _b === void 0 ? void 0 : _b.call(this, this.id);
        }
    }
    recoveryFilters(relay) {
...
class CommandResult {
    ...
    consumeResult(e) {
        ...
        this.results.push(e);
        (_a = this.onResult) === null || _a === void 0 ? void 0 : _a.call(this, e);
...
class Mux {
    constructor() {
        ...
        this.handleRelayEvent = (e) => {
            ...
            (_a = this.subs[e.received.subscriptionID]) === null || _a === void 0 ? void 0 : _a.consumeEvent(e);
        };
        this.handleRelayEose = (e) => {
            var _a;
            (_a = this.subs[e.received.subscriptionID]) === null || _a === void 0 ? void 0 : _a.consumeEose(e.relay.url);
        };
        this.handleRelayResult = (e) => {
     ...
     */
    waitRelayBecomesHealthy(n, timeout) {
...
;// CONCATENATED MODULE: ./node_modules/nostr-mux/dist/plugin/auto_profile_subscriber.js

const parseGenericProfile = (content) => {
    const profile = {};
...
class LRUCache {
    constructor(capacity, autoEvict) {
        this.cache = new Map();
 ...
 */
class AutoProfileSubscriber extends mux_Plugin {
    constructor(options) {
        super();
        ...
        this.cache = new LRUCache(options.cacheCapacity || 1000, typeof options.autoEvict === 'boolean' ? options.autoEvict : false);
        ...
        this.ticker = () => {
            ...
            for (const pubkey of this.pubkeyBacklog) {
                if (this.cache.has(pubkey)) {
                    this.resolveWaitingPromises(pubkey, (_a = this.cache.get(pubkey)) === null || _a === void 0 ? void 0 : _a.foundProfile);
                    continue;
                }
                results[pubkey] = { foundProfile: undefined };
                (_b = filter.authors) === null || _b === void 0 ? void 0 : _b.push(pubkey);
            }
            this.pubkeyBacklog.clear(); // To accept pubkey while ticker is running.
            if (((_c = filter.authors) === null || _c === void 0 ? void 0 : _c.length) === 0) {
                this.finishTicker();
                return;
            }
            let resolved = false;
            const resolveAll = () => {
                ...
                resolved = true;
                (_a = this.mux) === null || _a === void 0 ? void 0 : _a.unSubscribe(autoProfileSubscriberSubID);
            ...
            (_d = this.mux) === null || _d === void 0 ? void 0 : _d.subscribe({
                ...
                onPartialEose: (_, relayURL, expectedEoses, remain) => {
                    var _a;
                    if (!resolved && ((_a = this.earlyCallbackPredicate) === null || _a === void 0 ? void 0 : _a.call(this, relayURL, expectedEoses, remain))) {
                        resolveAll();
                    }
                },
                onEose: resolveAll,
    ...
    capturePublishedEvent(event) {
        var _a;
        const collected = ((_a = this.collectPubkeyFromEvent) === null || _a === void 0 ? void 0 : _a.call(this, event, undefined)) || [];
    ...
    captureRequestedFilter(filter) {
        var _a;
        const collected = ((_a = this.collectPubkeyFromFilter) === null || _a === void 0 ? void 0 : _a.call(this, filter)) || [];
        for (const pubkey of collected) {
            this.enqueueBacklog(pubkey);
        }
    }
    captureReceivedEvent(e) {
        var _a;
        const collected = ((_a = this.collectPubkeyFromEvent) === null || _a === void 0 ? void 0 : _a.call(this, e.received.event, e.relay.url)) || [];
        for (const pubkey of collected) {
            this.enqueueBacklog(pubkey);
        }
    }
    get(pubkey) {
        ...
        if (this.cache.has(pubkey)) {
            return Promise.resolve((_a = this.cache.get(pubkey)) === null || _a === void 0 ? void 0 : _a.foundProfile);
        }
        this.enqueueBacklog(pubkey);
    ...
    resolveWaitingPromises(pubkey, result) {
...
;// CONCATENATED MODULE: ./node_modules/nostr-mux/dist/plugin/personalizer.js
...
class ReplaceableEventHolder {
    constructor(pubkey, kind) {
        this.pubkey = pubkey;
        this.kind = kind;
...
class GenericReplaceableEventHolder extends (/* unused pure expression or super */ null && (ReplaceableEventHolder)) {
    accept() {
        return true;
    }
}
class ContactListHolder extends (/* unused pure expression or super */ null && (ReplaceableEventHolder)) {
    constructor(pubkey, log) {
...
class RelayListHolder extends (/* unused pure expression or super */ null && (ReplaceableEventHolder)) {
    constructor(pubkey, log, mux, relayOptsTpl) {
    ...
    accept(event) {
        ...
        for (const entry of parsed) {
            ...
            if (already) {
                ...
                added++;
                this.mux.addRelay(new Relay(entry.url, Object.assign(Object.assign({}, this.relayOptsTpl), { logger: this.log, read: entry.read, write: entry.write })));
            }
        }
...
const atLeastOneFilter = (filters) => {
    return filters.length > 0;
};
/**
 * `Personalizer` plugin loads and applis data of user that is specified pubkey
 */
class Personalizer extends (/* unused pure expression or super */ null && (Plugin)) {
    constructor(pubkey, options) {
        ...
        this.genericHolders = (options.cacheReplaceableEvent || []).map(kind => (new GenericReplaceableEventHolder(this.pubkey, kind)));
    ...
    get contactListEntries() {
        var _a;
        return ((_a = this.contactList) === null || _a === void 0 ? void 0 : _a.currentEntries) || [];
    }
    getCachedReplaceableEvent(kind) {
        var _a;
        return (_a = this.genericHolders.find(h => h.targetKind === kind)) === null || _a === void 0 ? void 0 : _a.leastEvent;
    }
    id() {
    ...
    install(mux) {
        this.mux = mux;
        const holders = [...this.genericHolders];
        ...
        if (this.contactListOpts.enable) {
            ...
            this.contactList.onUpdated.listen(() => { var _a; return this.onUpdatedContactList.emit(((_a = this.contactList) === null || _a === void 0 ? void 0 : _a.currentEntries) || []); });
    ...
    uninstall() {
        var _a, _b;
        (_a = this.mux) === null || _a === void 0 ? void 0 : _a.unSubscribe(subID);
        (_b = this.contactList) === null || _b === void 0 ? void 0 : _b.onUpdated.reset();
        this.contactList = undefined;
        this.relayList = undefined;
        this.genericHolders = (this.genericHolders || []).map(holder => (new GenericReplaceableEventHolder(this.pubkey, holder.targetKind)));
    }
    capturePublishedEvent(event) {
        var _a, _b, _c;
        switch (event.kind) {
            case contactListKind:
                (_a = this.contactList) === null || _a === void 0 ? void 0 : _a.update(event);
                break;
            case relayListKind:
                (_b = this.relayList) === null || _b === void 0 ? void 0 : _b.update(event);
                break;
            default:
                (_c = this.genericHolders.find(h => h.targetKind === event.kind)) === null || _c === void 0 ? void 0 : _c.update(event);
                break;
        }
    }
}

;// CONCATENATED MODULE: ./node_modules/nostr-mux/dist/index.js
...
const dist_utils = {
    decodeBech32ID: utils/* decodeBech32ID */.$Q,
    encodeBech32ID: utils/* encodeBech32ID */.Ps,
};
